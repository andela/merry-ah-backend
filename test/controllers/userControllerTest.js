...
describe('Users Endpoint API Test', () => {
  describe('USERS POST REQUESTS', () => {
    ...
    it('it should not send a reset password mail to an invalid user', (done) => {
      chai.request(app)
      .post('/api/v1/auth/forgot-password')
      .send({
    ...
    it('it should check if token exists and return valid password token', (done) => {
      chai.request(app)
    ...
    it('it should return not reset password when passwords do not match', (done) => {
      chai.request(app)
      .put('/api/v1/auth/forgot-password')
      .set('x-access-token',userToken)
      .send({
